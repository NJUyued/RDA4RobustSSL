...
Code for ***RDA: Reciprocal Distribution Alignment for Robust Semi-supervised Learning*** [[arXiv](https://arxiv.org/abs/2208.04619) | [Paper](https://www.ecva.net/papers/eccv_2022/papers_ECCV/papers/136900527.pdf) | [Poster](/figures/poster.jpg) | [Code](https://github.com/NJUyued/RDA4RobustSSL/archive/refs/heads/master.zip)].
...
> Related works:
> - 🆕 Interested in the conventional semi-supervised learning? Check out our TNNLS [paper](https://arxiv.org/abs/2203.14316) and [code](https://github.com/NJUyued/MutexMatch4SSL/).
